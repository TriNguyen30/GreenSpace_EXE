...
const MOCK_ARTICLES: Record<string, Article> = {
  "1": {
    ...
    excerpt: "Khám phá những loại cây cảnh phổ biến có khả năng lọc không khí tuyệt vời, phù hợp cho không gian sống hiện đại.",
    ...
    content: [
      ...
      "**1. Cây trầu bà (Pothos)**\nCây trầu bà là một trong những loại cây dễ trồng nhất, có khả năng phát triển tốt trong điều kiện ánh sáng yếu. Cây có thể loại bỏ formaldehyde, xylene và benzene từ không khí.",
      "**2. Cây lưỡi hổ (Snake Plant)**\nCây lưỡi hổ nổi tiếng với khả năng chuyển hóa CO2 thành O2 vào ban đêm, khác với hầu hết các loại cây khác. Đây là lựa chọn hoàn hảo cho phòng ngủ.",
      "**3. Cây môn (Peace Lily)**\nCây môn không chỉ đẹp mắt mà còn là một trong những loại cây lọc không khí tốt nhất. Có thể loại bỏ ammonia, benzene, formaldehyde và trichloroethylene.",
      "**4. Cây lô hội (Aloe Vera)**\nNgoài công dụng làm đẹp và chữa bỏng, cây lô hội còn có khả năng loại bỏ formaldehyde và benzene. Cây rất dễ chăm sóc.",
      "**5. Cây phong lộc (Spider Plant)**\nCây phong lộc có khả năng loại bỏ formaldehyde và xylene. Đây là loại cây phát triển rất nhanh và dễ nhân giống.",
    ],
  },
  "2": {
    id: "2",
    title: "Cách tưới nước đúng cách cho cây cảnh trong mùa hè",
    excerpt: "Hướng dẫn chi tiết về tần suất và phương pháp tưới nước để cây luôn xanh tốt trong những tháng nóng bức.",
    ...
    content: [
      "Tưới nước là một trong những yếu tố quan trọng nhất trong việc chăm sóc cây cảnh, đặc biệt trong mùa hè khi nhiệt độ cao và độ ẩm thấp.",
      "**Thời điểm tưới nước**\nTưới nước vào sáng sớm (5-7 giờ) hoặc chiều mát (sau 17 giờ) là thời điểm lý tưởng. Tránh tưới vào giữa trưa khi nắng gắt.",
      "**Tần suất tưới**\nKiểm tra độ ẩm đất bằng cách ấn ngón tay xuống đất khoảng 2-3cm. Nếu đất khô, đã đến lúc cần tưới. Đối với cây trong chậu, có thể cần tưới 1-2 lần/ngày.",
      "**Lượng nước**\nTưới đẫm cho đến khi nước chảy ra từ lỗ thoát nước ở đáy chậu. Điều này đảm bảo rễ cây được cung cấp đủ nước.",
    ],
  },
  "3": {
    id: "3",
    title: "Thiết kế vườn nhỏ: Biến ban công thành ốc đảo xanh",
    excerpt: "Những ý tưởng sáng tạo để tận dụng không gian ban công nhỏ, tạo nên góc vườn xanh mát trong căn hộ chung cư.",
    image: "https://images.unsplash.com/photo-1558904541-efa843a96f01?w=800&q=80",
    category: "Thiết kế vườn",
    date: "2024-02-15",
    readTime: "6 phút đọc",
    author: "Green Space Team",
    tags: ["Ban công", "Trang trí", "Căn hộ"],
    content: [
      "Ban công chung cư thường có diện tích hạn chế, nhưng nếu biết cách sắp xếp, bạn hoàn toàn có thể biến nó thành một nơi thư giãn lý tưởng.",
      "**Lựa chọn chậu trồng thông minh**\nSử dụng các loại chậu treo, chậu kẹp lan can hoặc kệ nhiều tầng để tận dụng tối đa không gian theo chiều dọc.",
      "**Chọn cây phù hợp hướng nắng**\nNếu ban công hướng Tây có nắng gắt, hãy chọn xương rồng, sen đá. Nếu ban công khuất nắng, trầu bà là lựa chọn tuyệt vời.",
      "**Tạo điểm nhấn với đèn trang trí**\nThêm một vài dây đèn LED sẽ biến khu vườn nhỏ của bạn trở nên lung linh hơn vào ban đêm.",
    ],
  },
  "4": {
    id: "4",
    title: "Top 5 loại phân bón hữu cơ tốt nhất cho cây trồng trong chậu",
    excerpt: "So sánh và đánh giá các loại phân bón tự nhiên giúp cây phát triển khỏe mạnh mà không gây hại môi trường.",
    image: "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=800&q=80",
    category: "Chăm sóc cây",
    date: "2024-02-12",
    readTime: "7 phút đọc",
    author: "Green Space Team",
    tags: ["Phân bón", "Hữu cơ", "Dinh dưỡng"],
    content: [
      "Sử dụng phân bón hữu cơ không chỉ giúp cây bền vững mà còn cải tạo cấu trúc đất, tránh tình trạng đất bị chai cứng.",
      "**1. Phân trùn quế:** Loại phân giàu dinh dưỡng và an toàn tuyệt đối, không gây cháy rễ cho cây.",
      "**2. Phân bò hoai mục:** Cung cấp mùn tốt, tuy nhiên cần đảm bảo phân đã được xử lý kỹ.",
      "**3. Dịch chuối:** Rất giàu Kali, giúp cây ra hoa đẹp và tăng cường sức đề kháng.",
      "**4. Bã cà phê:** Giúp bổ sung đạm và cải thiện độ tơi xốp cho đất trồng.",
    ],
  },
  "5": {
    id: "5",
    title: "Xu hướng cây cảnh 2024: Những giống cây đang được ưa chuộng",
    excerpt: "Cập nhật những xu hướng mới nhất trong thế giới cây cảnh, từ các giống cây quý hiếm đến phong cách trang trí.",
    image: "https://images.unsplash.com/photo-1459156212016-c812468e2115?w=800&q=80",
    category: "Tin tức",
    date: "2024-02-10",
    readTime: "5 phút đọc",
    author: "Green Space Team",
    tags: ["Xu hướng", "Nội thất", "Cây quý"],
    content: [
      "Năm 2024 đánh dấu sự lên ngôi của các dòng cây có lá đột biến (Variegated) và những loại cây mang đậm tính kiến trúc.",
      "**Cây lá màu lên ngôi:** Các dòng Monstera Thai Constellation vẫn giữ sức hút cực lớn nhờ những mảng màu trắng nghệ thuật trên lá.",
      "**Phong cách tối giản (Minimalism):** Những loại cây có hình dáng thanh mảnh như cây Kim Ngân được ưa chuộng hơn cả.",
    ],
  },
  "6": {
    id: "6",
    title: "Cách nhận biết và xử lý sâu bệnh trên cây cảnh",
    excerpt: "Hướng dẫn chi tiết về các loại sâu bệnh phổ biến và phương pháp phòng trừ hiệu quả, an toàn cho cây.",
    image: "https://tse3.mm.bing.net/th/id/OIP.2yy3dnrd8vv0wdmbpQGsugHaE8?rs=1&pid=ImgDetMain&o=7&rm=3",
    category: "Mẹo hữu ích",
    date: "2024-02-08",
    readTime: "8 phút đọc",
    author: "Green Space Team",
    tags: ["Sâu bệnh", "Bảo vệ cây", "Mẹo"],
    content: [
      "Việc phát hiện sớm dấu hiệu bệnh là chìa khóa để cứu sống cây cảnh của bạn trước khi dịch bệnh lan rộng.",
      "**Rệp sáp:** Những đốm trắng nhỏ như bông bám trên cuống lá. Cách xử lý: Dùng cồn 70 độ lau sạch.",
      "**Nấm lá:** Các vết đốm nâu hoặc đen lan rộng. Cần cắt bỏ lá bệnh ngay lập tức và giữ cho lá luôn khô thoáng.",
      "**Thối rễ:** Do tưới quá nhiều nước. Cần thay đất mới và sử dụng thuốc kích rễ.",
    ],
  },
  "7": {
    id: "7",
    title: "Bí quyết chăm sóc sen đá và xương rồng cho người mới bắt đầu",
    excerpt: "Những điều cần biết khi trồng và chăm sóc các loại cây mọng nước, phù hợp cho người bận rộn.",
    image: "https://images.unsplash.com/photo-1509587584298-0f3b3a3a1797?w=800&q=80",
    category: "Chăm sóc cây",
    date: "2024-02-05",
    readTime: "4 phút đọc",
    author: "Green Space Team",
    tags: ["Sen đá", "Xương rồng", "Mọng nước"],
    content: [
      "Dù được coi là loại cây 'dễ tính', nhưng sen đá vẫn thường chết do sai lầm trong cách tưới nước.",
      "**Đất trồng:** Phải cực kỳ thoát nước. Công thức lý tưởng là trộn đá Perlite và xỉ than.",
      "**Ánh sáng:** Sen đá cần ít nhất 4-6 tiếng ánh sáng mặt trời mỗi ngày để giữ được màu sắc rực rỡ.",
      "**Quy tắc tưới:** Chỉ tưới khi đất đã khô hoàn toàn. Tránh tưới trực tiếp lên lá gây thối ngọn.",
    ],
  },
  "8": {
    id: "8",
    title: "Tạo vườn thẳng đứng: Giải pháp xanh cho không gian hẹp",
    excerpt: "Khám phá cách thiết kế và thực hiện vườn tường, mang thiên nhiên vào ngôi nhà của bạn một cách thông minh.",
    image: "https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?w=800&q=80",
    category: "Thiết kế vườn",
    date: "2024-02-03",
    readTime: "6 phút đọc",
    author: "Green Space Team",
    tags: ["Vườn đứng", "Tiết kiệm diện tích", "Không gian nhỏ"],
    content: [
      "Vườn thẳng đứng (Vertical Garden) là giải pháp tuyệt vời cho những căn hộ phố không có diện tích sân vườn rộng.",
      "**Hệ thống module:** Bạn có thể sử dụng các bộ khung nhựa lắp đặt lên tường để tiết kiệm sàn nhà.",
      "**Hệ thống tưới tự động:** Một hệ thống tưới nhỏ giọt sẽ giúp bạn tiết kiệm thời gian và đảm bảo cây luôn đủ ẩm.",
      "**Lựa chọn cây trồng:** Nên chọn những loại cây có bộ rễ không quá lớn như: Dương xỉ, Ngũ gia bì.",
    ],
  },
};
