...
const CSS = `
  ...
  /* Hide scrollbar */
  .ol-scrollbar-hide::-webkit-scrollbar { display: none; }
  .ol-scrollbar-hide { -ms-overflow-style: none; scrollbar-width: none; }
`;
...
export default function OrderListPage() {
  ...
  const onMouseDown = (e: React.MouseEvent) => {
    ...
    if (filterRef.current) {
      ...
      scrollLeft.current = filterRef.current.scrollLeft;
    }
  };
  const onMouseLeave = () => {
  ...
  const filteredOrders =
    filterStatus === "ALL"
      ? orderList
      : orderList.filter(
          (o) => (o.status ?? "").toString().toUpperCase() === filterStatus,
        );
    ...
    <div className="min-h-screen bg-gray-50 pt-24 pb-14">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div
          ...
          className="ol-e1 flex flex-nowrap overflow-x-auto bg-white mb-5 ol-scrollbar-hide shadow-sm border border-gray-100 cursor-grab active:cursor-grabbing select-none"
        >
          <button
            onClick={() => setFilterStatus("ALL")}
            className={`flex-1 shrink-0 py-4 px-4 min-w-[120px] text-center text-sm font-medium whitespace-nowrap transition-colors cursor-pointer border-b-2 ${
              filterStatus === "ALL"
            ...
            filteredOrders.map((order, i) => {
              ...
              return (
                <div
                  ...
                  className="ol-card bg-white border border-gray-100 shadow-sm p-5 cursor-pointer"
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2 mb-1">
                        ...
                        <span
                          className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-xs font-semibold border ${status.cls}`}
                        >
                          <span
